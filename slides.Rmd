...
- Ryhmäerojen posteriori-varianssia voidaan havainnollistaa generoimalla posteriorijakaumasta
- Malli post1:
...
```{r, echo=TRUE}
loo1 <- loo(post1); loo2 <- loo(post2); loo3 <- loo(post3); loo4 <- loo(post4)
